...
1.Tahir Ahmed Shaik (CS20MTECH14007)
2.Pratik Madhukar Lahase(CS20MTECH11003)
3.Jaykishan Pipaliya (CS20MTECH11012)
...
class AdvancedFirewall:
    ...
    def manageRules(self):
        print("**********************************************************************\n")
        print("*\u001b[44m\t\t\t\tADVANCE FIREWALL RULE MANAGEMENT\u001b[0m           *\n")
        print("**********************************************************************\n")
        print("1.ADD RULE\n")
        print("2.UPDATE RULE\n")
        print("3.DELETE RULE\n")
        ...
        if opt == 1:
            ...
            print("2.IP Rule (layer 3)\n")
            print("3.TCP Rule (layer 4)\n")
            print("4.UDP Rule (layer 4)\n")
            print("5.ICMP Rule (Layer 3)\n")
            ...
            if rule_opt == 1:
                ...
                print("\u001b[33;1mEnter the rule in analogical form: Field----Field----Rule(Allow/Discard)")
                ...
                print("\u001b[42mRule Inserted\u001b[0m\n")
            elif rule_opt == 2:
                if int(input("Enter Type of IP Rule (4/6)")) == 4:
                    print("\u001b[33;1mIPv4 Rule\u001b[0m\n")
                    print("\u001b[33;1mEnter the rule in analogical form: Field----Field----Rule(Allow/Discard)\u001b[0m")
                ...
                for rule in self.all_rules["IPv4rules"]:
                    ...
                    for key in rule.keys():
                        ...
                        if type(rule[key]) is int:
                            ...
                            rule[key] = updated
                    print("\u001b[42mRule Updated\n")
                    updated = True
                    break

            if updated == False:
                print("\u001b[41mNo Such Rule Found\u001b[0m\n")
            ...
            for rulecat in self.all_rules.keys():
                ...
                if deleted == True:
                    ...
                    print("\u001b[41mRule Deleted\u001b[0m\n")
                    break
            if deleted == False:
                print("\u001b[41mNo Such Rule Found\u001b[0m\n")

        elif opt == 4:
            print("\u001b[46mExisting Rules In System\u001b[0m")
            for rulecat in self.all_rules.keys():
                print("**************************\n")
                print(rulecat, "\n")
                print("**************************\n")
            ...
            for rule in self.all_rules[rulecat]:
                ...
                if match == True:
                    if rule["rule"].lower() == "allow":
                        ...
                        allowed = False
        if (
            self.dos_track[self.matching_map["v4source_addr"]] > self.dos_threshold
        ):  # Checking DOS threshold, if the IP crosses dos threshold, probable DoS attack , hence discard packet
            ...
            while True:
                ...
                for soc in ready_socks:
                    ...
                    if ret == True:
                        ...
                        print(
                            "Packet \u001b[42;1m Allowed  \u001b[0m\t Packet Type: ",
                            ptype,
                            "\tPacket Shape : ",
                            self.packet,
                            "Process Time : ",
                        ...
                        print(
                            "Packet \u001b[41;1m Discarded\u001b[0m\t Packet Type: ",
                            ptype,
                            "\tPacket Shape : ",
                            self.packet,
                            "Process Time : ",
    ...
    def getStatistics(self):  # This method prints and plots various performance related metrics of the firewall system
        ...
        print(
            "No of rules in system : ",
            len(self.all_rules["Ether_rules"])
            + len(self.all_rules["IPv4rules"])
            + len(self.all_rules["IPv6rules"])
            + len(self.all_rules["TCPrules"])
            + len(self.all_rules["UDPrules"]),
        )
        max_match = 0
    ...
    while True:
        if firewall_opt == "simple_firewall":
            ...
            while True:
                ...
                print("\u001b[33;1m1.Start Firewall\u001b[0m\n")
                print("\u001b[33;1m2.Print Firewall description\u001b[0m\n")
                print("\u001b[33;1m3.Manage Rules\u001b[0m\n")
                print("\u001b[33;1m4.Statistics\u001b[0m\n")
                print("\u001b[33;1m5.Save Rules\u001b[0m\n")
                print("\u001b[33;1m6.Load Rules\u001b[0m\n")
                print("\u001b[33;1m7 DoS Threshold\u001b[0m\n")
                print("\u001b[33;1m8.Exit\u001b[0m\n")
                option = int(input("Enter Your Choice:\n"))
                ...
                if option == 1:
                    ...
                    print(banner)
                    print(
                        "\u001b[36;1mAdvanced Firewall represents the complex and full scale dynamic firewall system, which provides rule management, statistics report, etc. It supports from layer 2 to layer 4.\u001b[0m\n"
                    )
                    input("\u001b[31;1mPress Enter to continue\u001b[0m\n")
                elif option == 3:
                    af.manageRules()
                    ...
                    af.saveRules()
                    input("\u001b[31;1mRules Saved\u001b[0m\n")
                    input("\u001b[31;1mPress Enter to continue\u001b[0m\n")

                elif option == 6:
                    af.loadRules()
                    input("\u001b[31;1mRules Loaded\u001b[0m\n")
                    input("\u001b[31;1mPress Enter to continue\u001b[0m\n")

                elif option == 7:
                    af.set_dos_threshold()
                    input("\u001b[31;1mThreshold Updated..Press Enter\u001b[0m\n")
